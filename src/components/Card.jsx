...
const Card = ({ isRed, onClick }) => {
  ...
  return (
    <div
      ...
      className={`relative ${isRed ? 'w-[592px] h-[461px] px-16 py-10' : 'w-[294px] h-[461px] p-6'} 
    ...
    >
      ...
      <div ref={verticalTextRef} className="flex flex-col items-center rotate-[-90deg] -mt-4">
